...
class MediatorTest {
  ...
  private List<Function<Integer, Mediator.MediatorPanel<Panel>>> panelSuppliers;
  private List<Mediator.MediatorPlayer<Player>> testPlayers;
  private List<Mediator.MediatorWildUnit<WildUnit>> testWildUnits;
  private List<Mediator.MediatorBoss<BossUnit>> testBosses;
  ...
  public void testAddPanel() {
    ...
    int expectedSize = 0;
    for (Function<Integer, Mediator.MediatorPanel<Panel>> supplier : panelSuppliers) {
  ...
  public void testMeetPlayer() {
    ...
    /*Se comenta por error inesperado en código que no se puede editar
